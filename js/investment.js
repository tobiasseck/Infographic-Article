...
var current_date = getDate(d.datum)
var tip = d3.tip()
    .attr('class', 'tooltip')
    .offset([-4, 0])
    .html(function (d){if (d.investors > 1) {return "<strong>" + d.investee + "</strong><hr style='margin-top: 6px; margin-bottom: 2px' /><span style='font-size:11px'>Raised: " + d.summe + " M. USD<br />by " + d.investors + " Investors.<br />Datum: " + current_date + "</span>";} else {return "<strong>" + d.investee + "</strong><hr style='margin-top: 6px; margin-bottom: 2px' /><span style='font-size:11px'>Raised: " + d.summe + " M. USD<br />by " + d.investors + " Investor.<br />Datum: " + d.datum + "</span>";}});
