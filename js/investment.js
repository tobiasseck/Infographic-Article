...
investment = [
  ...
  {"investee": "Female Legends","datum": "2018-02-19","summe": 	0.66355	,"investors":	1	},
  ...
  {"investee": "Game Scorekeeper","datum": "2017-07-07","summe": 	0.23833	,"investors":	1	},
  ...
  {"investee": "Battle of Glory","datum": "2015-11-01","summe": 	0.1272	,"investors":	2	},
  ...
  {"investee": "Challengermode","datum": "2015-08-20","summe": 	0.71429	,"investors":	8	},
  {"investee": "Matcherino","datum": "2015-08-07","summe": 	0.118	,"investors":	2	},
  {"investee": "Unikrn","datum": "2015-06-29","summe": 	7.00	,"investors":	6	},
  {"investee": "Strafe","datum": "2015-06-08","summe": 	0.625	,"investors":	3	},
...
var tip = d3.tip()
    .attr('class', 'tooltip')
    .offset([-4, 0])
    .html(function (d){if (d.investors > 1) {return "<strong>" + d.investee + "</strong><hr style='margin-top: 6px; margin-bottom: 2px' /><span style='font-size:11px'>Raised: " + d.summe + " M. USD<br />by " + d.investors + " Investors.<br />" + scalehelper + "</span>";} else {return "<strong>" + d.investee + "</strong><hr style='margin-top: 6px; margin-bottom: 2px' /><span style='font-size:11px'>Raised: " + d.summe + " M. USD<br />by " + d.investors + " Investor.</span>";}});
